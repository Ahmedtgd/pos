            ...
            <div class="panel-heading display-table" >
                <div class="row display-tr" >
                    ...
                    <div class="display-td" >
                        <img class="img-responsive pull-right" src="https://www.online.citibank.co.in/citihelp/topics/credit-card/how-does-credit-card-interest-work/images/banner-mobile.jpg">
                    </div>
                </div>
            </div>
            <div class="panel-body">
                ...
                {!! Form::open(['url' => route('order-post'), 'data-parsley-validate', 'id' => 'payment-form']) !!}
                    ...
                    <div class="form-group" id="product-group">
                        ...
                        {!! Form::select('plane', ['price_1KWakPBsJTTd2n8m5OUYh37N' => 'oil ($40)','price_1KVUK8BsJTTd2n8m4Qapz93X' => 'rice ($20)'], null, [
                            'class'                       => 'form-control',
                            'required'                    => 'required',
